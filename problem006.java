...
public class Problem6 {
  ...
  public static void main(String[] args) {
    System.out.printf("The sum of the squares of the first 100 natural " +
      "numbers is %d.\n", sumOfSquares(100));
    System.out.printf("The square of the sum of the first 100 natural " +
      "numbers is %d.\n", squareOfSum(100));
  ...
  public static int squareOfSum(int n) {
    ...
    // Adds all of the numbers from 1 to the integer specified, inclusive.
    for (int i = 1; i <= n; i++) {
      sum += i;
    }
